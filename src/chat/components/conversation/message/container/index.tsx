...
export function MessageContainer({ variant, children }: MessageWapperProps) {
  return (
    <div
      className={clsx({
        "w-fit h-fit text-primary rounded-3xl px-6 py-[19.5px] text-sm mb-1 max-w-80 leading-[18px]":
          true,
